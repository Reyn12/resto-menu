...
if ($kategori_id > 0) {
    $query .= " AND menu.id_kategori = $kategori_id";
}

$result = mysqli_query($koneksi, $query);

// Array gambar default
$default_images = [
    ...
    <div class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="p-4">
            ...
            <div class="flex justify-between items-center mt-3">
                ...
                <button onclick="addToOrder(<?php echo $menu['id_menu']; ?>, '<?php echo htmlspecialchars(addslashes($menu['nama_menu'])); ?>', <?php echo $menu['harga']; ?>, '<?php echo htmlspecialchars(addslashes($image)); ?>')"
